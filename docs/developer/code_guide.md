...
#### Code
1. Follows PEP 8 style for python code 
2. Re-raises should be avoided with respect to PEP 8 style suggestion of minimizing try/except code. If needed it should meet one of the following conditions
...
3. Descriptive log and error messages 
4. Try to create your own exceptions when raising one instead of pre-built exceptions
5. Imports should be alphabetic while still following PEP 8 style 
6. Copyright line at the top, see [copyrights and licensing](developer/copyrights_licenses.md)
